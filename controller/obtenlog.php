<?php
    ...
    $texto = "ERROR: ";
        ...
        $consulta = 'SELECT r.id_reserva, r.id_cliente, r.clave_institucion, r.horario, r.num_adultos, r.num_ninos, r.num_insen FROM reserva r WHERE r.id_tour = '.$datos['id_tour']." AND r.horario = CAST('".$datos['id_horario']."' as TIME)";
